...
class ManageProducts extends StatefulWidget {
  ...
  const ManageProducts({Key? key, required this.token, required this.id})
      : super(key: key);
...
class _ManageProductsState extends State<ManageProducts> {
  ...
  Future<void> sortBy(fieldName) async {
    product =
        await UserApi.getSellerProducts(fieldName, widget.token, widget.id);
    setState(() {});
  }

  @override
  initState() {
    fetchOrders(widget.token, widget.id, currentPage);
  }
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color:
                            Colors.black38.withOpacity(0.5), //color of shadow
        ...
        child: Column(
          children: [
            FutureBuilder<List<Product>>(
              future: fetchOrders(token, id, currentPage),
                ...
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      String s = prod!.inStock.toString() == 'false'
                          ? 'In stock'
                          : 'Out of stock';
                      return Column(
                        children: [
                              ...
                              Expanded(
                                child: Container(
                                  margin: EdgeInsets.only(
                                      bottom: 5, top: 5, left: 11, right: 10),
  ...
  //fetch product all
  Future<List<Product>> fetchOrders(token, id, currentPage) async {
    final data = await UserApi.getProducts(token, id, currentPage);
    return data;
  }
